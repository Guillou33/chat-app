...
function Contact() {
  return (
    <div className='Contact'>
      <img className='avatar' src={customer.photo} alt='customer-photo' />
      <div className='status'>
        <h4 className='name'>{customer.name.first}</h4>
        <div className='status-online'></div>
        <p className='status-text'>{customer.online ? 'Online' : 'Offline'}</p>
      </div>
    </div>
  );
}
